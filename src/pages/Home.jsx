...
const DESTINATIONS_DATA = [
  ...
  { id: 3, name: 'Jaipur', country: 'India', rating: 4.7, image: 'https://images.unsplash.com/photo-1477587458883-471a5ed942e5?auto=format&fit=crop&w=400&q=80' },
  ...
  { id: 5, name: 'Ladakh', country: 'India', rating: 4.9, image: 'https://images.unsplash.com/photo-1544085311-115edd9264b2?auto=format&fit=crop&w=400&q=80' }
];
      ...
      <main className="home-main-content">
        <div className="home-layout-wrapper">
          ...
          <section className="previous-trips-section" aria-labelledby="trips-heading">
            <header className="section-header">
              <h2 id="trips-heading" className="section-title">Previous Trips</h2>
            </header>
            ...
            {/* ── 6. Plan a Trip Floating Action Button ── */}
